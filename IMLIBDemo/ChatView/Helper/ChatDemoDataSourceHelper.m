...
{
    NSArray *textArray  = @[
                            @"这个工程致力于完成一个优雅的IM实现方案:https://github.com/dormitory219/ChatKit,如果对这个工程有什么疑问,可以加入我的qq群：533793277 进行技术讨论，或者在我的简书上留言http://www.jianshu.com/p/f4a402f65de9。",
                            @"这个工程致力于完成一个优雅的IM实现方案。",
                            @"一位ios开发者。",
                            @"一位开发者,这个工程致力于完成一个优雅的IM实现方案:https://github.com/dormitory219/ChatKit,如果对这个工程有什么疑问,可以加入我的qq群533793277 进行技术讨论。"
